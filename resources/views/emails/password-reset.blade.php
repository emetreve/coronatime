...
<div style="height: 100%; max-width:500px; margin: 50px auto; text-align:center">
    ...
    <div>
        <h1 style="color: #010414; font-size: 1.5rem; font-weight: bold; text-align: center; margin-top: 1.5rem;">
            {{ __('password-reset.email_subject') }}</h1>
        <p style="color: #010414; font-size: 1.2rem  margin-top: 1.9rem;">{{ __('password-reset.email_line') }}</p>
        <a href="{{ $url }}">
            <button
                ...
                {{ __('password-reset.email_action') }}
            </button>
        </a>
    </div>
</div>
