<x-layout>
    <div class="min-h-screen px-4 relative">
        ...
        <div class="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center pb-16 lg:pb-32">
            <img class="h-20 pt-6 lg:h-24" src="{{ asset('images/checkmark.gif') }}" />
            <p class="text-gray-600 text-center mt-4 lg:text-2xl">{{ __('email-verification.account_confirmed') }}</p>
